...
*   Respect the `MAX_TOOL_OUTPUT` registry cap. Use the optional block arguments with compatible tools like a filesystem read or youtube_transcript to paginate long results. 
