...
class ChatPanel(QWidget):
    ...
    _ROLE_MAP = {
        "sentinel":  ("The Sentinel",  "#FF5722"),
        "scholar":   ("The Scholar",   "#9C27B0"),
        "architect": ("The Architect", "#00BCD4"),
        "analyst":   ("The Analyst",   "#E91E63"),
        "manager":   ("The Manager",   "#FF9800"),
        "guardian":  ("The Guardian",  "#4CAF50"),
    }
    _DEFAULT_ROLE = ("Assistant", "#2196F3")
